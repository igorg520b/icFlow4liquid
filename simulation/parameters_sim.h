...
public:
    ...
    void Reset()
    {
        ...
        YoungsModulus = 100000; // 3e9;
        FractureTractionThreshold = 1e4; // 1e6;
        ...
        FractureTemporalAttenuation = InitialTimeStep*2;
        ...
        // cohesive zones
        cz_alpha = cz_beta = 4;
        cz_lambda_n = cz_lambda_t = 0.02;
        cz_phi_n = cz_phi_t = 5;// 30; // fracture energy
        cz_sigma_max = cz_tau_max = 3e3; //5e5;
        RecomputeCZParams();
    }
